...
public final class Resources {
    ...
    public static class Resource {
        ...
        /**
         * Holds the {@link ResourceURL} to this Resource.
         */
        private final ArrayList<ResourceURL> sources;
         ...
         * @return A {@link ResourceURL} {@link ArrayList}.
         */
        public ArrayList<ResourceURL> sources() {
            return sources;
        }
    } // end of Resource
    ...
    private static URL getRemoteResource(String file, String[] startPaths) {
        String[] cases = new String[] {
                ...
                "target/classes/com/airent/extendedjavafxnodes/",
                "target/test-classes/com/airent/extendedjavafxnodes/",
                "src/main/resources/com/airent/extendedjavafxnodes/",
                "src/test/resources/com/airent/extendedjavafxnodes/",
                "src/main/java/com/airent/extendedjavafxnodes/",
                "src/test/java/com/airent/extendedjavafxnodes/",
    ...
    public static Resource getResource(String file, ResourceType type) {
        ...
        if (type == ResourceType.REMOTE) {
            ...
            if (type == ResourceType.INTERNAL) {
                startPaths = new String[] {
                        "target/classes/com/airent/extendedjavafxnodes/",
                        "target/classes/com/airent/extendedjavafxnodes/control/",
                        "target/classes/com/airent/extendedjavafxnodes/utils/"
                };
    ...
    public enum ResourceType {
        /**
         * Defines that a resource is predefined.
         */
        INTERNAL,
        /**
